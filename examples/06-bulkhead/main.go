// Example 06-bulkhead: Demonstrates concurrency limiting with the bulkhead pattern.
package main
...
func main() {
	...
	// Launch 6 concurrent calls. Only 3 should succeed; the rest get ErrBulkheadFull.
	...
	for i := 1; i <= 6; i++ {
		...
		go func(id int) {
			...
			if errors.Is(err, r8e.ErrBulkheadFull) {
