...
func main() {
	...
	result, err := staticPolicy.Do(ctx, func(ctx context.Context) (string, error) {
	...
	result, err = funcPolicy.Do(ctx, func(ctx context.Context) (string, error) {
	...
	_, err = failingFbPolicy.Do(ctx, func(ctx context.Context) (string, error) {
