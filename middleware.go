...
// Each middleware receives the next function in the chain and returns a wrapped version.
...
// Chain() with zero middlewares returns an identity middleware that passes through to next.
